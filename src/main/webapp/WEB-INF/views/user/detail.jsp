        ...
        <div id="employee-detail-contents" >
            ...
            <form id="detail-modify-form" action="/employees/modify" method="POST">
                <div class="detail-infos" id="detail-infos-top">
                    ...
                    <label for="detail-locate">사내위치 &nbsp; </label>
                    <input id="detail-locate" name="location" value="${employee.location}" placeholder="사내 위치를 입력하세요">
                </div>
                <div class="detail-infos" id="external-email-container">
                    <i class="fa-solid fa-envelope"></i>
                    <label for="detail-external-email">외부 이메일주소 &nbsp; </label>
                    <input id="detail-external-email" name="externalEmail" value="${employee.externalEmail}" style="width: 19rem;" placeholder="외부 이메일 주소를 입력하세요">
                </div>
                <div class="detail-infos" id="phone-number-container">
                    <i class="fa-solid fa-square-phone"></i>
                    <label for="detail-phone-number">전화번호 &nbsp; </label>
                    <input id="detail-phone-number" name="phoneNum" value="${employee.phoneNum}" placeholder="전화번호를 입력하세요 (예: 010-1234-5678)">
                </div>
                <div class="detail-infos" id="fax-number-container">
                    <i class="fa-solid fa-print"></i>
                    <label for="detail-fax-number">팩스번호 &nbsp; </label>
                    <input id="detail-fax-number" name="fax" value="${employee.fax}" placeholder="팩스번호를 입력하세요 (예: 02-123-4567)">
                </div>
